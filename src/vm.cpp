...
InterpretResult run() {
    while (true) {
        ...
        switch (instruction) {
            ...
            case OP_NIL: vm.value_stack.push(Value(nullptr)); break;
            case OP_TRUE: vm.value_stack.push(Value(true)); break;
            case OP_FALSE: vm.value_stack.push(Value(false)); break;
